...
OBSIDIAN_VAULT = Path(
    os.getenv("OBSIDIAN_VAULT", r"D:\iCloudDrive\iCloud~md~obsidian\Mind Castle")
).resolve()

# Whisper Configuration
WHISPER_EXE = Path(
    os.getenv("WHISPER_EXE", r"C:\Tools\whisper.cpp-gpu\whisper-cli.exe")
).resolve()
WHISPER_MODEL = Path(
    os.getenv("WHISPER_MODEL", r"C:\Tools\whisper.cpp\models\ggml-medium.en.bin")
).resolve()
